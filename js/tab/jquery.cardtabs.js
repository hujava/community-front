jQuery.fn.cardTabs = function(options){
	...
	function toggleTab(obj){
		...
		/* 点击定位 */
		if(obj[0].innerHTML=="活动介绍"){
			if(bool==false){
                $("html, body").animate({scrollTop: $(".mok1").offset().top-80}, {duration: 500,easing: "swing"});
			}else {
                $("html, body").animate({scrollTop: $(".mok1").offset().top-30}, {duration: 500,easing: "swing"});
                bool=true;
			}
			bool=true;

            return false;
		}else if(obj[0].innerHTML=="活动评论"){
			if(bool==false){
				$("html, body").animate({scrollTop: $(".mok2").offset().top-140 }, {duration: 500,easing: "swing"});
			}else {
				$("html, body").animate({scrollTop: $(".mok2").offset().top-140 }, {duration: 500,easing: "swing"});
                bool=true;
			}
		...
		if(obj[0].innerHTML=="课程介绍"){
			...
			bool=true;
            return false;
		}else if(obj[0].innerHTML=="课程评论"){
			if(bool==false){
				$("html, body").animate({scrollTop: $(".mok3").offset().top-140 }, {duration: 500,easing: "swing"});
			}else {
				$("html, body").animate({scrollTop: $(".mok3").offset().top-140 }, {duration: 500,easing: "swing"});
                bool=true;
			}
