        ...
        success: function (data) {
            if (data.code == 200) {
                ...
                $(".fl_pj>span").click(function () {
                    ...
                    $.ajax({
                        type: "post",
                        url: httpXhr + "courseAndSubjectController/selectCourseAndSubject.do?pc=1&typeObj=0&rows=12&page=" + num,
                        dataType: "json",
                        data: {
                            hb_type: class_hb,
                            sub_id: class_fl
...
function init_rd(num) {
    $.ajax({
        type: "post",
        url: httpXhr + "courseAndSubjectController/selectCourseAndSubject.do?sort=course_id&pc=1&typeObj=0&rows=12&page=" + num,
        dataType: "json",
        async: false,
        success: function (data) {
            $(".class_list").html("");
    ...
    $.ajax({
        type: "post",
        url: httpXhr + "courseAndSubjectController/selectCourseAndSubject.do?pc=1&sort=course_upNum&typeObj=0",
        dataType: "json",
        success: function (data) {
...
function zhpfs(num) {
    $(".con_titlen > div").click(function () {
        ...
        if ($(this).attr("value") == "1") {
            httpdouble = httpXhr + "courseAndSubjectController/selectCourseAndSubject.do?pc=1&sort=course_id&typeObj=0&rows=12&page=" + num;
        } else {
            httpdouble = httpXhr + "courseAndSubjectController/selectCourseAndSubject.do?pc=1&sort=course_upNum&typeObj=0&rows=12&page=" + num;
        }
        $.ajax({
            type: "post",
            url: httpdouble,
...
$(".list_data>span").click(function () {
    ...
    $.ajax({
        type: "post",
        url: httpXhr + "courseAndSubjectController/selectCourseAndSubject.do?pc=1&typeObj=0",
        dataType: "json",
        data: {
            age_list: class_xd,
            hb_type: class_hb,
...
function lunbo() {
    $.ajax({
        type: "post",
        url: httpXhr + "questionAndAnswerController/questionAndAnswerList.do?pc=1&user_id=0",
        dataType: "json",
        success: function (data) {
            console.log(data);
            if (data.code == "200") {
